...
|---|---|---|---|---|
|方法|释义|消耗资金量|优缺点|示例图|
|逢山开路遇水架桥|如同其字面意思，碰到山了就开出一条路（直接挖开山体或打隧道）|比较烧钱，毕竟工程量摆在那|优点：几乎不绕路<br>缺点：烧钱|图片|
|人字展线|如果您不知道的话可以找找您的小学语文课本或者乘坐一遍北京市郊铁路S2线|比较省钱，只用修铁路就ok了|优点：真的很省钱<br>缺点:列车需要频繁换向折返，效率差|图片|
|螺旋展线|以延长走行距离的方式减小在同等路程下爬升的高度|资金消耗一般水平|优点:无需折返，消耗资金量不多<br>缺点:展线起终点之间列车走行距离常常数倍于两点间直线距离，转弯多|图片|
|加挂补机|在列车编组中添加第二台甚至更多机车，是一种力大砖飞式策略|优点：理论上没有力大砖飞克服不了的坡<br>缺点:请记住OpenTTD世界中的列车是固定编组的，加挂更多机车会导致运行费用暴涨|图片|
