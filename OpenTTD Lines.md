...
不难发现，增加站台数切实地提升了车站的接发效率，不过轨道数过多也是不可行的，当轨道数多于4时，每条轨道对接发效率的贡献不足75%/条，又因为外侧轨道本身就距离正线远，此时我们面临的是复线铁路本身的瓶颈了。对于一个停车时间较短的客运站，双向四站台是完全足够了。
...
有！接下来请容我为你介绍**平行进路**！简单点解释就是——如果把火车进站的轨迹看作水流，那么两股甚至以上的“火车水流”之间没有交叉，互不干扰，宛若平行线。现实中，一些规模不大却要接发大量列车的铁路枢纽车站，其行车组织人员会频繁地使用这个方法缓解交叉车流对咽喉区带来的压力。
最简单实施平行进路的方法就是通过在车站咽喉区设置与正线相连接的"辅助股道"，这些辅助股道平行于车站正线，其可以直接汇入正线，也可以接入车库或作铁路线与铁路线间的联络线使用。在车流量庞大的大型车站，平行进路法将极为有效的提高列车通行效率。
...
一旦一趟列车利用了平行进路种设置的“辅助股道”进站，那么在咽喉区大量道岔构成的树状组织的帮助下，就有机会为即将切割正线折返的列车创造出一条与进站列车的路线互不干扰的路线，从而减少因为咽喉区占用增长的等待时间。
...
如前文所说，玩家可以在游戏中修建过山车式轨道。但是我们不提倡修建这种线路。这种线路缺乏逻辑性与效率，在经验玩家看来是人体思维中枢的部分机制出现错误的表示。过山车轨道bu'jin'bu'm式
